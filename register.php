...
?>" required>
            ...
            <a href="#" id="login_link" onclick="switchToRegisterForm()">New? Click here to sign up!</a>
            <!-- i could put this script into a different file. Should I? -->
            <script>
          ...
          <!-- Register -->
          <!-- Start with the signup hidden showing only the login form -->
...
?>" required>
    ...
    ?>" required>
            ...
            <br>
            <a href="#" id="register_link" onclick="switchToLoginForm()">Already have an account? Click here.</a>
            <!-- i could put this script into a different file. Should I? -->
            <script>
